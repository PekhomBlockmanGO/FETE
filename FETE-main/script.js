...
const questions = [
    ...
    {
        type: "text",
        question: "Ratan Tata declared his decision to move the Tata Nano Project out of West Bengal due to the opposition movement of which project?",
        options: ["Singur Project", "Raniganj Project", "Siliguri Project"],
        correctAnswer: "Singur Project"
    },
    {
        type: "text",
        question: "Which startup company originated from Bengal?",
        options: ["L&T India", "Wow! Momo", "Infosys"],
        correctAnswer: "Wow! Momo"
    },
    {
        type: "text",
        question: "Which one of the newest metro expansions in Kolkata is under trial runs?",
        options: ["Green Line Corridor", "Purple Line Corridor", "Orange Line Corridor"],
        correctAnswer: "Orange Line Corridor"
    },
];
