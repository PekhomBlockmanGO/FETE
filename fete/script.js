...
const questions = [
    ...
    },
    {
        ...
        options: ["1024 bytes", "2000 bytes", "8 bytes"],
    ...
    },
    {
        ...
        options: ["Monte Carlo", "Capgemini", "TCS"],
        correctAnswer: "Monte Carlo"
    },
    {
        type: "text",
        question: "What was the first computer virus ever invented?",
        options: ["Stuxnet virus", "Creeper virus", "Stuxnet virus"],
        correctAnswer: "Creeper virus"
    },
    {
        type: "text",
        question: "Who was the inventor of WWW (World Wide Web)? ",
        options: ["Stephen Hawking", "Mark Zuckerberg", "Tim Berners-Lee"],
        correctAnswer: "Tim Berners-Lee"
    },
    {
        type: "text",
        question: "Which scientist was present in the previous logo of Apple?",
        options: ["Joseph Priestly", "Isaac Newton", "Robert Oppenheimer"],
        correctAnswer: "Isaac Newton"
    },
    {
        type: "text",
        question: "The PS5 console contains four signs: circle, triangle, cross and which other shape?",
        options: ["Square", "Rectangle", "Pentagon"],
        correctAnswer: "Square"
    },
    {
        type: "text",
        question: "What is MS Access?",
        options: ["A scanning software", "A database software", "A presentation software"],
    ...
    type: "picture",
        ...
        options: ["Soccer Super League", "FIFA 24", "EA FC 24"],
        correctAnswer: "EA FC 24"
    },
    {
        type: "picture",
            question: "From which state of USA are the memes originated?",
            imageUrl: "Picture2.jpg", 
            options: ["Las Vegas", "Ohio", "California"],
            correctAnswer: "Ohio"
        },
...
function checkAnswer() {
    ...
    if (selectedAnswer) {
        ...
        if (userAnswer === correctAnswer) {
            resultContainer.textContent = "Your answer is correct! ٩(◕‿◕)۶";
            resultContainer.classList.remove("incorrect");
            resultContainer.classList.add("correct");
        } else {
            resultContainer.textContent = `Your answer is incorrect ಥ‿ಥ`;
